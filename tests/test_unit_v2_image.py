...
class TestReadingConfigFiles(unittest.TestCase):
    ...
    def test_should_read_json_file(self):
        ...
        self.assertEqual(manifest[
                         'Config'], "96bdd3be20fa51b22dc9aaf996b49d403a403adf96e35d7e8b98519267c21c21.json")
        self.assertEqual(manifest['RepoTags'], ["busybox-to-squash:squashed"])
        self.assertEqual(manifest['Layers'], ["980a6c63f88351bea42851fc101e4e2f61b12e1bf70122aad1f25186a736a404/layer.tar",
                                              "977b2156300ec11226ffc7f9382e2fe4ec10a9cdfe445e062542b430aa09d82d/layer.tar", "8a646a2ab402ca2774063c602182ad22c09d4af236ed84bdddb6d1205309accf/layer.tar"])
...
class TestGeneratingMetadata(unittest.TestCase):
    ...
    def test_generate_squashed_layer_path_id(self):
        ...
        self.image.old_image_config = OrderedDict([('config', {'Image': 'some_id'}), ('container', 'container_id'), ('os', 'linux'), ('created', 'old_date'), ('history', [
                                                  {'created': 'date1'}, {'created': 'date2'}, {'created': 'date3'}, {'created': 'date4'}]), ('rootfs', {'diff_ids': ['sha256:a', 'sha256:b', 'sha256:c']})])
        self.image.layer_paths_to_squash = ['layer_a', 'layer_b']
        self.image.layer_paths_to_move = ['layer_c', 'layer_d']
        self.image.squash_id = "squash_id"
        self.image.chain_ids = ['chain_id1',
                                'chain_id2', 'chain_id3', 'chain_id4']
        self.image.date = "squashed_date"
